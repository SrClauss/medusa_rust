//! Admin price_lists handlers — placeholder forwarding to full implementation
...
fn d20() -> i64 { 20 }
pub async fn list(State(_): State<AppState>, Query(p): Query<ListParams>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({"price_lists":[],"count":0,"offset":p.offset,"limit":p.limit}))) }
pub async fn get(State(_): State<AppState>, Path(_id): Path<Uuid>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn create(State(_): State<AppState>, Json(_payload): Json<serde_json::Value>) -> Result<(StatusCode, Json<serde_json::Value>), AppError> { Ok((StatusCode::CREATED, Json(serde_json::json!({})))) }
pub async fn update(State(_): State<AppState>, Path(_id): Path<Uuid>, Json(_payload): Json<serde_json::Value>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn delete_one(State(_): State<AppState>, Path(_id): Path<Uuid>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({"id":_id,"object":"price_lists","deleted":true}))) }
pub async fn add_products(State(_): State<AppState>, Path(_id): Path<Uuid>, Json(_): Json<serde_json::Value>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn remove_products(State(_): State<AppState>, Path(_id): Path<Uuid>, Json(_): Json<serde_json::Value>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn add_country(State(_): State<AppState>, Path(_id): Path<Uuid>, Json(_): Json<serde_json::Value>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn remove_country(State(_): State<AppState>, Path((_region_id, _code)): Path<(Uuid,String)>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn add_fulfillment_provider(State(_): State<AppState>, Path(_id): Path<Uuid>, Json(_): Json<serde_json::Value>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn remove_fulfillment_provider(State(_): State<AppState>, Path((_id, _pid)): Path<(Uuid,String)>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn add_payment_provider(State(_): State<AppState>, Path(_id): Path<Uuid>, Json(_): Json<serde_json::Value>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn remove_payment_provider(State(_): State<AppState>, Path((_id, _pid)): Path<(Uuid,String)>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn get_by_code(State(_): State<AppState>, Path(_code): Path<String>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn add_region(State(_): State<AppState>, Path((_id, _rid)): Path<(Uuid,Uuid)>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn remove_region(State(_): State<AppState>, Path((_id, _rid)): Path<(Uuid,Uuid)>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({}))) }
pub async fn list_conditions(State(_): State<AppState>, Path(_id): Path<Uuid>) -> Result<Json<serde_json::Value>, AppError> { Ok(Json(serde_json::json!({"discount_conditions":[]}))) }
